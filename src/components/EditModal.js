...
let EditModal = (props) => {
  ...
  return (
    <div className={styles.modal} onClick={props.setIsOpen(false)}>FFFFFF
      {/* <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
          ...
          <form className={styles.taskForm} onSubmit={handleSubmit}>
            ...
            <div className={styles.flexContainer}>
              ...
              <div>
                ...
                <br />
                <input className={styles.formDate} type="date" 
                value={deadline ?? ""}
        ...
        <div className={styles.modalFooter}>
          <button onClick={props.setIsOpen(false)} className="closeModalBtn">
            Close
          </button>
          <br />
          <br />
